...
function get_options() {
    ...
    $config_file = './'.$docs_lib.'/config.json';
...
function load_page($tree) {
	...
	if (isset($branch['type']) && $branch['type'] == 'file') {
		...
		if ($branch['name'] !== 'index') {
            $page['improve_btn'] = '<a href="https://github.com/MaxLazar/docs/edit/master/' . $branch['path'] . '" target="_blank" title="You must be logged into Github for this to work." class="btn btn-primary pull-right improve-button">Improve This Page</a>';
...
function get_dir_tree($path = '.', $clean_path = '', $title = '', $first = true){
     $tree = array();
     $dh = @opendir($path);
     $index = 0;
